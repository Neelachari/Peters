...
const Heading1 = () => {
  return (
    ...
    <div style={{width:"87.5w", paddingLeft:"15%", justifyContent:"space-evenly"}}>
      <SimpleGrid columns={4} spacing={2} mt={"0px"} >
        <Box p={5}  height={"20vh"} mr={"6"} background={"white"} borderRadius={"10px"} boxShadow='rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset' >
        ...
        <Box p={5} height={"20vh"} mr={"6"} background={"#02AB6C"} borderRadius={"10px"} boxShadow='rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset'>
